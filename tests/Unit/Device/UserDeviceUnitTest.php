...
class UserDeviceUnitTest extends TestCase
{
    use RefreshDatabase;
    ...
    // {
    //     $response = $this->withoutMiddleware()->post('/devices', [
    //         'name' => 'Kolam 02',
    //         'topic' => 'finbites/test2',
    //         'capacity' => 12,
    //     ]);
    ...
    public function test_berhasil_menambahkan_perangkat_dengan_data_valid()
    {
        ...
        $response->assertRedirect(route('devices.simple'));
        $response->assertSessionHas('toast_success', 'Data Kolam 02 berhasil ditambahkan');
    }
    ...
    //     $response = $this->withoutMiddleware()->put("/devices/{$device->id}", [
    //         'name' => 'Kolam 02',
    //         'topic' => 'finbites/test2',
    //     ]);
    ...
    public function test_gagal_mengubah_perangkat_dengan_duplicate_topic()
    {
        ...
        $device = Device::factory()->create(['name' => 'Kolam 02', 'topic' => 'finbites/test2', 'user_id' => $this->user->id]);
    ...
    public function test_berhasil_mengubah_perangkat_dengan_data_valid()
    {
        ...
        $response = $this->withoutMiddleware()->put("/devices/{$device->id}", [
            'user_id' => $this->user->id,
            'name' => 'Kolam 22',
            'topic' => 'finbites/test22',
        ]);

        $response->assertRedirect(route('devices.simple'));
        $response->assertSessionHas('toast_success', 'Data Kolam 22 berhasil diperbarui');
    }
    ...
    public function test_berhasil_menghapus_perangkat()
    {
        ...
        // $response = $this->withoutMiddleware()->delete("/devices/{$device->id}/delete");

            ...
            @forelse ($users as $user)
              <tr>
                ...
                <td>
                  ...
                  <div class="d-flex">
                    <div class="pe-3">
                      <a href="{{ route('users.edit', ['user' => $user->id]) }}" class="btn btn-finbites-edit"><i
            ...
            <tr>
              ...
              <td>
                <div class="d-flex">
                  ...
                  <div>
                    <a href="{{ route('users.destroy', ['user' => $user->id]) }}" class="btn btn-finbites-delete"
                      data-confirm-delete="true"><i class="lni lni-trash-can"></i></a>
                  </div>
                </div>
